...
final class QueryTest extends Tests\TestCase
{
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table')->createPgQuery();
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column = $1', 1)->createPgQuery();
		Tester\Assert::same('SELECT * FROM table WHERE column = $1', $query->sql);
		Tester\Assert::same([1], $query->params);

		$query = Db\Sql\Query::createArgs('SELECT * FROM table WHERE column = $1', [1])->createPgQuery();
		Tester\Assert::same('SELECT * FROM table WHERE column = $1', $query->sql);
		Tester\Assert::same([1], $query->params);

		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column = ?', 1)->createPgQuery();
		Tester\Assert::same('SELECT * FROM table WHERE column = $1', $query->sql);
		Tester\Assert::same([1], $query->params);

		$query = Db\Sql\Query::createArgs('SELECT * FROM table WHERE column = ?', [1])->createPgQuery();
		Tester\Assert::same('SELECT * FROM table WHERE column = $1', $query->sql);
		Tester\Assert::same([1], $query->params);
	}
	...
	public function testPrepareQueryWithMissingParam(): void
	{
		Tester\Assert::exception(static function (): void {
			Db\Sql\Query::create('SELECT * FROM table WHERE column = ? AND column2 = ?', 1)->createPgQuery();
	...
	{
		Tester\Assert::exception(static function (): void {
			Db\Sql\Query::create('SELECT * FROM table WHERE column = ?', 1, 2)->createPgQuery();
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM ? WHERE column = ?', Db\Sql\Literal::create('table'), 1)->createPgQuery();
		Tester\Assert::same('SELECT * FROM table WHERE column = $1', $query->sql);
		Tester\Assert::same([1], $query->params);
	}
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM ? WHERE column = ?', Db\Sql\Expression::create('function(?, ?)', 'param1', 2), 1)->createPgQuery();
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column IN (?)', [1, 2])->createPgQuery();
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column1 = ? AND column2 IN (?)', 3, [10 => 2, 20 => 1])->createPgQuery();
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column IN (?)', [])->createPgQuery();
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column = ANY(?)', Db\Helper::createPgArray([1, 2]))->createPgQuery();
	...
	public function testPrepareQueryWithQuery(): void
	{
		...
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE id IN (?)', $subquery)->createPgQuery();
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column = ?', Tests\TestEnum::One)->createPgQuery();
		Tester\Assert::same('SELECT * FROM table WHERE column = $1', $query->sql);
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column IN (?)', [Tests\TestEnum::Two, Tests\TestEnum::One])->createPgQuery();
		Tester\Assert::same('SELECT * FROM table WHERE column IN ($1, $2)', $query->sql);
	...
	{
		$query = Db\Sql\Query::create('SELECT * FROM table WHERE column = ? AND text ILIKE \'What\?\'', 1)->createPgQuery();
